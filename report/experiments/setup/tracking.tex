...
khớp tại khung hình $t$~\cite{bernardin2008clear}.
...
danh tính~\cite{ristani2016idf1}.
...
\begin{equation}
    \HOTA = \int_0^1 \HOTA_\alpha\, d\alpha \approx \frac{1}{19} \sum_{\alpha
    \in \{0.05, 0.1, \dots, 0.95\}} \HOTA_\alpha.
